...
@:keep @:noCompletion #if display private #end class __ASSET__assets_fonts_mars_needs_cunnilingus_ttf extends lime.text.Font { public function new () { __fontPath = ManifestResources.rootPath + "assets/fonts/Mars Needs Cunnilingus.ttf"; name = "Mars Needs Cunnilingus"; super (); }}
@:keep @:noCompletion #if display private #end class __ASSET__assets_fonts_monsterfriendfore_otf extends lime.text.Font { public function new () { __fontPath = ManifestResources.rootPath + "assets/fonts/MonsterFriendFore.otf"; name = "Monster Friend Fore"; super (); }}


#else

@:keep @:expose('__ASSET__assets_fonts_mars_needs_cunnilingus_ttf') @:noCompletion #if display private #end class __ASSET__assets_fonts_mars_needs_cunnilingus_ttf extends lime.text.Font { public function new () { #if !html5 __fontPath = "assets/fonts/Mars Needs Cunnilingus.ttf"; #else ascender = null; descender = null; height = null; numGlyphs = null; underlinePosition = null; underlineThickness = null; unitsPerEM = null; #end name = "Mars Needs Cunnilingus"; super (); }}
@:keep @:expose('__ASSET__assets_fonts_monsterfriendfore_otf') @:noCompletion #if display private #end class __ASSET__assets_fonts_monsterfriendfore_otf extends lime.text.Font { public function new () { #if !html5 __fontPath = "assets/fonts/MonsterFriendFore.otf"; #else ascender = null; descender = null; height = null; numGlyphs = null; underlinePosition = null; underlineThickness = null; unitsPerEM = null; #end name = "Monster Friend Fore"; super (); }}
...
#if html5
@:keep @:expose('__ASSET__OPENFL__assets_fonts_mars_needs_cunnilingus_ttf') @:noCompletion #if display private #end class __ASSET__OPENFL__assets_fonts_mars_needs_cunnilingus_ttf extends openfl.text.Font { public function new () { name = "Mars Needs Cunnilingus"; super (); }}
@:keep @:expose('__ASSET__OPENFL__assets_fonts_monsterfriendfore_otf') @:noCompletion #if display private #end class __ASSET__OPENFL__assets_fonts_monsterfriendfore_otf extends openfl.text.Font { public function new () { name = "Monster Friend Fore"; super (); }}
@:keep @:expose('__ASSET__OPENFL__flixel_fonts_nokiafc22_ttf') @:noCompletion #if display private #end class __ASSET__OPENFL__flixel_fonts_nokiafc22_ttf extends openfl.text.Font { public function new () { __fromLimeFont (new __ASSET__flixel_fonts_nokiafc22_ttf ()); super (); }}
@:keep @:expose('__ASSET__OPENFL__flixel_fonts_monsterrat_ttf') @:noCompletion #if display private #end class __ASSET__OPENFL__flixel_fonts_monsterrat_ttf extends openfl.text.Font { public function new () { __fromLimeFont (new __ASSET__flixel_fonts_monsterrat_ttf ()); super (); }}

#else
@:keep @:expose('__ASSET__OPENFL__assets_fonts_mars_needs_cunnilingus_ttf') @:noCompletion #if display private #end class __ASSET__OPENFL__assets_fonts_mars_needs_cunnilingus_ttf extends openfl.text.Font { public function new () { __fontPath = ManifestResources.rootPath + "assets/fonts/Mars Needs Cunnilingus.ttf"; name = "Mars Needs Cunnilingus"; super (); }}
@:keep @:expose('__ASSET__OPENFL__assets_fonts_monsterfriendfore_otf') @:noCompletion #if display private #end class __ASSET__OPENFL__assets_fonts_monsterfriendfore_otf extends openfl.text.Font { public function new () { __fontPath = ManifestResources.rootPath + "assets/fonts/MonsterFriendFore.otf"; name = "Monster Friend Fore"; super (); }}
@:keep @:expose('__ASSET__OPENFL__flixel_fonts_nokiafc22_ttf') @:noCompletion #if display private #end class __ASSET__OPENFL__flixel_fonts_nokiafc22_ttf extends openfl.text.Font { public function new () { __fromLimeFont (new __ASSET__flixel_fonts_nokiafc22_ttf ()); super (); }}
@:keep @:expose('__ASSET__OPENFL__flixel_fonts_monsterrat_ttf') @:noCompletion #if display private #end class __ASSET__OPENFL__flixel_fonts_monsterrat_ttf extends openfl.text.Font { public function new () { __fromLimeFont (new __ASSET__flixel_fonts_monsterrat_ttf ()); super (); }}
